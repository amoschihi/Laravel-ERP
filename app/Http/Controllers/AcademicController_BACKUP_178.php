...
<<<<<<< HEAD
        /*
        * GRADE = (ASSIGNMENT+CAT)/2 + EXAM
        * INCOMPLETE GRADE (**) = EITHER ASSIGNMENT, CAT OR EXAM MISSING
        * SUPPLEMENTARY (*) = OVERALL GRADE === F
        * 
        */
        //Check for missing marks
        if(
            ($request->m_assignmentmissing == true && $request->m_assignment == null) || 
            ($request->m_catmissing == true && $request->m_cat == null) || 
            ($request->m_exammissing == true && $request->m_exam == null)
        )
         {
            // No grade
            // No total marks
...
>>>>>>> 080ae08b8da792d464d8927be34fe683744d07fc
        $units = array(
...
<<<<<<< HEAD
            'm_assignmentmissing'=>$request->m_assignmentmissing=="on"?true:false,
            'm_cat'=>$request->m_cat,
            'm_catmissing'=>$request->m_catmissing=="on"?true:false,
            'm_exam'=>$request->m_exam,
            'm_exammissing'=>$request->m_exammissing=="on"?true:false,
=======
            'm_cat'=>$request->m_cat,
            'm_exam'=>$request->m_exam,
>>>>>>> 080ae08b8da792d464d8927be34fe683744d07fc
