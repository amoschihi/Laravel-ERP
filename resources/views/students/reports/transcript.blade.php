...
<a data-toggle="tooltip" data-placement="bottom" title="Print Transcript" class="btn btn-flat btn-primary pull-right" id="printTranscript"><i class="fa fa-print"></i> </a>
<div class="printTranscript body">
	<div id="container">
		<div class="length-limit">
			<table style="width: 100%;margin: 0 auto;text-align: left;border-collapse: collapse;">
				<tr style="border-bottom: 1px solid; padding-left: 10px; font-family: 'Times News Roman','Khmer OS Muol Light';">
					...
					<th style="width:33%;text-align: center;"><b>PROVISIONAL TRANSCRIPT</b></th>
			...
			<table style="width: 100%;margin: 0 auto;text-align: left;border-collapse: collapse;">
				...
				<tr>
					...
					<td style="background-color: #fff; border: 1px solid; text-align: center;">{{$marks->m_grade == "*" ? $marks->m_grade."*" : $marks->m_grade }}</td>
				</tr>
				@endforeach
				<tr style="background: #eee;">
					<td colspan="6"><span style="font-weight: bold;">Current Performance:</span>&nbsp;&nbsp; [<b>{{ $getMarks->count() }}/{{ $units->count() }} Units</b>] &nbsp;<span style="font-weight: bold;">Credit Hours:</span>&nbsp;&nbsp; <b>{{ $getMarks->sum('unit_hours') }}</b> &nbsp;<span style="font-weight: bold;">Mean Score:</span> &nbsp;&nbsp;<b>{{ round($getMarks->avg('m_total_marks'),2) }}</b> &nbsp;<span style="font-weight: bold;">Mean Grade:</span> &nbsp;&nbsp;<b>
						@php
				...
				<tr style="background: #eee;">
					<td colspan="6"><span style="font-weight: bold;">Overall Performance:</span>&nbsp;&nbsp; - &nbsp;<span style="font-weight: bold;">Credit Hours:</span>&nbsp;&nbsp; - &nbsp;<span style="font-weight: bold;">Mean Score:</span> &nbsp;&nbsp;- &nbsp;<span style="font-weight: bold;">Mean Grade:</span> &nbsp;&nbsp;-</td>
				</tr>
				<table style="width: 100%;">
					<tr style=";background: #eee;">
						<td width="25%">RECOMMENDATION</td>
						<td width="75%">
							<select style="width: 100%" name="recommendation" id="recommendation">
								<option value="Proceed" {{ $getMarks->where('m_grade','F')->count() !=0 ? "" : "selected" }}>PASS: Proceed</option>
								<option value="Fail" {{ $getMarks->where('m_grade','F')->count() !=0 ? "selected" : "" }}>FAIL</option>
							</select>
						</td>
					</tr>
				</table>
				...
				<tr>
					...
					<td>
						<table style="border-collapse: collapse;">
							...
							<tr>
								<td style="background-color: #fff; border: 1px solid; text-align: center;">F</td>
								<td style="background-color: #fff; border: 1px solid; text-align: center;">Supplementary</td>
							</tr>
							<tr>
								<td style="background-color: #fff; border: 1px solid; text-align: center;">**</td>
								<td style="background-color: #fff; border: 1px solid; text-align: center;">Incomplete</td>
							</tr>
						</table>
					</td>
					<td>
			...
			<table style="width: 100%;margin: 0 auto;text-align: left;border-collapse: collapse;">
				...
				<tr>
					<td style="font-style: italic;text-align: center;" colspan="6">*This transcript is issued without any erasures or alterations</td>
				</tr>
			</table>
		</div>
	</div>
